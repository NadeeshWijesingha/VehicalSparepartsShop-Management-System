...
public class DeliveryController {
    ...
    public void btnSave_OnAction(ActionEvent actionEvent) {
        ...
        if (btnSave.getText().equals("Save")) {
            ...
            try {
                result = deliveryBO.updateDelivery(comboOrderId.getSelectionModel().getSelectedItem(),
                        txtAddress.getText(),
                        comboStatus.getSelectionModel().getSelectedItem(), txtDeliveryId.getText());

                if (!result) {
                    System.out.println("before if result");
                    throw new RuntimeException("Something went wrong!");
                }
                ...
                new Alert(Alert.AlertType.INFORMATION, "Update not complete").show();
            }
        }
    }
